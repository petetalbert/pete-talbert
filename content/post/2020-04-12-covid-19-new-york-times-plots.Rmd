...
The New York Times has produced some really great maps and plots in its efforts to track the coronavirus in the U.S. One plot in particular that caught my attention is the histogram of new cases with a 7-day average line overlayed found at the top of this [page](https://www.nytimes.com/interactive/2020/us/coronavirus-us-cases.html) (and subsequent state pages).

Why not try to replicate that? I would also like to try to facet this plot out with all 50 states.

## Making the histogram

Making the histogram of new cases shouldn't be too difficult. I am going to use New York as my first state. Conveniently enough, The New York Times has a Github site where we can download the state-level data that creates the maps and plots on their site.
...
I hope this tutorial was helpful; I feel the best way to get better at `ggplot2` is to find plots on the internet you like, and try to recreate them in R.
